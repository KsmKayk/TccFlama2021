    ...
    <div class="card">
        <div class="card-body">
            <div class="d-flex justify-content-between mb-2">
                <h3>Categorias</h3>
                <a href="/admin/categories/new" class="btn btn-outline-success">Adicionar</a>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="d-flex justify-content-center mt-1 mb-1">
                                ...
                                <form method="POST"action="/admin/categories/{{$category->id}}/delete" onsubmit="return confirm ('Tem certeza que deseja remover a categoria: {{ addslashes($category->name) }}?')">
                                    @csrf
                                    @method('DELETE')
